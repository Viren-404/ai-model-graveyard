export default function TombstoneCard({ tool }) {
  const stars = Array(5).fill(0).map((_, i) => i < tool.popularity ? "⭐" : "☆");

  return (
    <div className="group relative bg-grave-card border border-grave-border rounded-2xl p-6 hover:border-grave-green transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,255,136,0.1)] cursor-pointer">
      
      {/* Tombstone top arch decoration */}
